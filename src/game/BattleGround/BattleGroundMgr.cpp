...
/**
  ...
  @param    arena team id
*/
GroupQueueInfo* BattleGroundQueue::AddGroup(Player* leader, Group* group, BattleGroundTypeId bgTypeId, BattleGroundBracketId bracketId, ArenaType arenaType, bool isRated, bool isPremade, uint32 instanceId, uint32 arenaRating, uint32 arenaTeamId)
{
    // create new ginfo
...
BattleGround* BattleGroundMgr::CreateNewBattleGround(BattleGroundTypeId bgTypeId, BattleGroundBracketId bracketId, ArenaType arenaType, bool isRated)
{
    ...
    switch (bgTypeId)
    {
        ...
        case BATTLEGROUND_BE:
            ...
            break;
        case BATTLEGROUND_AA:
            bg = new BattleGroundAA(*(BattleGroundAA*)bgTemplate);
            break;
        case BATTLEGROUND_EY:
